...
\usepackage[backend=bibtex,style=authoryear, dashed=false]{biblatex}  %% Literaturverwaltung
...
\subsubtitle{Bachelor-Thesis
			...
			\newline 
			 ...
			 \newline 
			 Matrikelnummer: \hspace{2.5mm} 2561916} %% Unteruntertitel

%\settitlepicture{Bilder/Titelbild} %% Titelbild laden

\setinstitutionlogo{Bilder/Ente}
...
%--------------------------------------------------------------------------------------------------	
%\listoffigures
%\addcontentsline{toc}{chapter}{Abbildungsverzeichnis}		% Abbildungsverzeichnis
%--------------------------------------------------------------------------------------------------	
%\listoftables
%\addcontentsline{toc}{chapter}{Tabellenverzeichnis}			% Tabellenverzeichnis
%--------------------------------------------------------------------------------------------------	
%\chapter*{Abkürzungen} \label{cha:Abkürzungen}				% Abkürzungen
%\addcontentsline{toc}{chapter}{Abkürzungen}					% Für nicht nummerierte Kapitel, damit
															% sie im Inhaltsverzeichnis auftauchen
%--------------------------------------------------------------------------------------------------	
\include{Kapitel/Kapitel1_Einleitung}						% Einleitung
%--------------------------------------------------------------------------------------------------	
\include{Kapitel/Kapitel2_StandDerTechnik}					% Stand der Technik
%--------------------------------------------------------------------------------------------------	
\include{Kapitel/Kapitel3_Menschmodell}						% Menschmodell
%--------------------------------------------------------------------------------------------------	
%\include{Kapitel/Kapitel4_InteraktionMitDerUmgebung}		% Interaktion mit der Umgebung
%--------------------------------------------------------------------------------------------------	
...
%--------------------------------------------------------------------------------------------------	
%\printbibliography
%\addcontentsline{toc}{chapter}{Literaturverzeichnis}		% Literatur Verzeichnis
%--------------------------------------------------------------------------------------------------	
