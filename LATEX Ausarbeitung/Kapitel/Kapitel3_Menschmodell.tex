...
Falls das Element „ModelExchange“ vorhanden ist, enthält die FMU selbst das entweder eigentliche Modell oder die Kommunikationsschnittstelle zu einem Tool, welches das Modell enthält. Die Simulationsumgebung kümmert sich dann um die Simulation.
...
\noindent bla bla blabla bla blabla bla blabla bla blabla bla blabla bla blabla bla blabla bla blabla bla blabla bla blabla bla blabla bla blabla bla blabla bla blabla bla blabla bla blabla bla blabla bla bla
...
\subsubsection{Aufbau des C-Codes}\label{sec:CCode}
